...
void SceneManager::SetupSceneLights()
{
	...
	/*/Light 3
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", glm::vec3(0.2f, 0.0f, 1.4f));
	m_pShaderManager->setVec3Value("lightSources[2].position", glm::vec3(5.0f, 1.5f, 2.0f));
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", glm::vec3(0.3f, 0.3f, 0.4f));
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", glm::vec3(0.3f, 0.3f, 0.1f));
...
void SceneManager::PrepareScene()
{
	...
	m_basicMeshes->LoadCylinderMesh();    // For pencil body
...
void SceneManager::RenderScene()
{
	...
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.75f, 0.8f, 1.0f); // Pink color for eraser
