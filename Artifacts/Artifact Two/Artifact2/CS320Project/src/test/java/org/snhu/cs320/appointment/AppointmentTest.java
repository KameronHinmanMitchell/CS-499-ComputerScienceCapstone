...
class AppointmentTest {
    ...
    @BeforeEach
    void setUp() {
        // Future date, updated with future in mind
        Calendar futureCal = Calendar.getInstance();
        futureCal.set(Calendar.YEAR, Calendar.getInstance().get(Calendar.YEAR) + 1);
        futureCal.set(Calendar.MONTH, Calendar.DECEMBER);
        futureCal.set(Calendar.DATE, 5);
        futureCal.set(Calendar.HOUR, 0);
        ...
        pastCal.set(Calendar.YEAR, 2000);
    ...
    void testUpdateDateWithValidDate() {
        ...
        newFutureCal.set(Calendar.YEAR, Calendar.getInstance().get(Calendar.YEAR) + 2);
        newFutureCal.set(Calendar.MONTH, Calendar.DECEMBER);
        newFutureCal.set(Calendar.DATE, 25);
    ...
    @Test
    @DisplayName("Test Description Update with Null")
    void testUpdateDescriptionWithNull() {
        Appointment appointment = new Appointment(validId, futureDate, validDescription);
