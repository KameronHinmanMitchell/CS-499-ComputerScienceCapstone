...
class TaskTest {
    ...
    void testTaskConstructorNullId() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(null, validTaskName, validDescription);
        });
    }
    ...
    void testTaskConstructorLongId() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(longId, validTaskName, validDescription);
        });
    }
    ...
    void testTaskConstructorLongName() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(validTaskId, longName, validDescription);
        });
    }
    ...
    void testTaskConstructorEmptyName() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(validTaskId, "", validDescription);
        });
    }
    ...
    void testTaskConstructorNullDescription() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(validTaskId, validTaskName, null);
        });
    }
    ...
    void testTaskConstructorLongDescription() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(validTaskId, validTaskName, longDescription);
        });
    }
    ...
    void testTaskConstructorEmptyDescription() {
        assertThrows(IllegalArgumentException.class, () -> {
            new Task(validTaskId, validTaskName, "");
        });
    }
